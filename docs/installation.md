...
1. Download the latest release:
    ```
    curl -L -O https://github.com/pilosa/pilosa/releases/download/{{< version >}}/pilosa-{{< version >}}-darwin-amd64.tar.gz
    ```
...
2. Extract the binary:
    ```
    tar xfz pilosa-{{< version >}}-darwin-amd64.tar.gz
    ```

3. Move the binary into your PATH so you can run `pilosa` from any shell:
    ```
    cp -i pilosa-{{< version >}}-darwin-amd64/pilosa /usr/local/bin
    ```
...
1. To install the latest version of Pilosa, download the latest release:
    ```
    curl -L -O https://github.com/pilosa/pilosa/releases/download/{{< version >}}/pilosa-{{< version >}}-linux-amd64.tar.gz
    ```
...
2. Extract the binary:
    ```
    tar xfz pilosa-{{< version >}}-linux-amd64.tar.gz
    ```

3. Move the binary into your PATH so you can run `pilosa` from any shell:
    ```
    cp -i pilosa-{{< version >}}-linux-amd64/pilosa /usr/local/bin
    ```
