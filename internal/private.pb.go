...
func (*Empty) Descriptor() ([]byte, []int) { return fileDescriptorPrivate, []int{6} }
...
func (*MaxSlicesResponse) Descriptor() ([]byte, []int) { return fileDescriptorPrivate, []int{7} }
...
func (*CreateSliceMessage) Descriptor() ([]byte, []int) { return fileDescriptorPrivate, []int{8} }
...
func (*DeleteIndexMessage) Descriptor() ([]byte, []int) { return fileDescriptorPrivate, []int{9} }
...
func (*CreateIndexMessage) Descriptor() ([]byte, []int) { return fileDescriptorPrivate, []int{10} }
...
func (*CreateFrameMessage) Descriptor() ([]byte, []int) { return fileDescriptorPrivate, []int{11} }
...
func (*DeleteFrameMessage) Descriptor() ([]byte, []int) { return fileDescriptorPrivate, []int{12} }
...
func (*Frame) Descriptor() ([]byte, []int) { return fileDescriptorPrivate, []int{13} }
...
func (*ClusterStatus) Descriptor() ([]byte, []int) { return fileDescriptorPrivate, []int{21} }
...
// Client API for General service

type GeneralClient interface {
	GetMaxSlices(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*MaxSlicesResponse, error)
}
...
func NewGeneralClient(cc *grpc.ClientConn) GeneralClient {
	return &generalClient{cc}
}

func (c *generalClient) GetMaxSlices(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*MaxSlicesResponse, error) {
	out := new(MaxSlicesResponse)
	err := grpc.Invoke(ctx, "/internal.General/GetMaxSlices", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// Server API for General service

type GeneralServer interface {
	GetMaxSlices(context.Context, *Empty) (*MaxSlicesResponse, error)
}

func RegisterGeneralServer(s *grpc.Server, srv GeneralServer) {
	s.RegisterService(&_General_serviceDesc, srv)
}

func _General_GetMaxSlices_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Empty)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(GeneralServer).GetMaxSlices(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/internal.General/GetMaxSlices",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(GeneralServer).GetMaxSlices(ctx, req.(*Empty))
	}
	return interceptor(ctx, in, info, handler)
}

var _General_serviceDesc = grpc.ServiceDesc{
	ServiceName: "internal.General",
	HandlerType: (*GeneralServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "GetMaxSlices",
			Handler:    _General_GetMaxSlices_Handler,
		},
	},
...
var fileDescriptorPrivate = []byte{
	...
	,
}
